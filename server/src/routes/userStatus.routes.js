...
const {userStatusPost, getUserWorkingQuestions,getUserWorkingQuestionsAdmin, updateApproval, updateWorkingQuestion, getTips, tipViews, ratings, updateCertification} = require("../controllers/userStatus.controller.js");
...
router.route("/updateCertification/:id").put(updateCertification);
